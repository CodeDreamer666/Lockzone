    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-V3UH6XDB.js"), import("./pbr.fragment-WOLPXFOE.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-IFPARKOJ.js"), import("./pbr.fragment-CEXX2MLS.js")]);
        }
...
//# sourceMappingURL=chunk-PM546VFM.js.map
