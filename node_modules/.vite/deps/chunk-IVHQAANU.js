    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-36OPHW34.js"), import("./openpbr.fragment-DOS3JXVC.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-S437QQLZ.js"), import("./openpbr.fragment-Y4C6N7SW.js")]);
        }
...
//# sourceMappingURL=chunk-IVHQAANU.js.map
