...
var _WebAudioStaticSoundBuffer = class __WebAudioStaticSoundBuffer extends StaticSoundBuffer {
  /** @internal */
  constructor(engine) {
    super(engine);
  }
  ...
  clone(options = null) {
    ...
    const buffer = new __WebAudioStaticSoundBuffer(this.engine);
...
var _WebAudioStaticSoundInstance = class extends _StaticSoundInstance {
  ...
  play(options = {}) {
    ...
    if (this.engine.state === "running") {
      ...
      this._sourceNode?.start(this._enginePlayTime, startOffset, this._options.duration > 0 ? this._options.duration : void 0);
  ...
  pause() {
    ...
    const wasStarted = this._state === 3;
    this._setState(
      5
      /* SoundState.Paused */
    );
...
//# sourceMappingURL=chunk-XSCLNBAW.js.map
