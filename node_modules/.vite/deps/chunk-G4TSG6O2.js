...
} from "./chunk-4EUN6PIV.js";
import {
  AbstractAudioNode,
  _WebAudioParameterComponent
} from "./chunk-GHKJURV6.js";
import {
  BoundingInfo,
  SubMesh
...
var AbstractMesh = class _AbstractMesh extends TransformNode {
  ...
  async optimizeIndicesAsync() {
    ...
    const { OptimizeIndices } = await import("./mesh.vertexData.functions-K5WK3YW3.js");
...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name, options = {}) {
    const module = await import("./webAudioBus-3CXDFHPW.js");
  ...
  async createMainBusAsync(name, options = {}) {
    const module = await import("./webAudioMainBus-NSG7NOP7.js");
  ...
  async createSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStaticSound-PDSNRJCA.js");
  ...
  async createSoundSourceAsync(name, source, options = {}) {
    const module = await import("./webAudioSoundSource-KEJBWAQB.js");
  ...
  async createStreamingSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStreamingSound-SG4AOPLQ.js");
...
//# sourceMappingURL=chunk-G4TSG6O2.js.map
