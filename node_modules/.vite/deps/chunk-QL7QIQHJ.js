...
var ObjectRenderer = class _ObjectRenderer {
  ...
  _createSceneUBO(name, isMultiview) {
    ...
    const ubo = new UniformBuffer(engine, void 0, isMultiview, name, void 0, false);
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  constructor(name, size, scene, generateMipMaps = false, doNotChangeAspectRatio = true, type = 0, isCube = false, samplingMode = Texture.TRILINEAR_SAMPLINGMODE, generateDepthBuffer = true, generateStencilBuffer = false, isMulti = false, format = 5, delayAllocation = false, samples, creationFlags, noColorAttachment = false, useSRGBBuffer = false) {
    ...
    this._onBeforeRenderingManagerRenderObserver = this._objectRenderer.onBeforeRenderingManagerRenderObservable.add(() => {
      ...
      if (!this._disableEngineStages) {
        for (const step of scene2._beforeRenderTargetClearStage) {
      ...
      if (this.onClearObservable.hasObservers()) {
        ...
        engine.clear(this.clearColor ?? scene2.clearColor, true, true, true);
      }
      if (!this._doNotChangeAspectRatio) {
        scene2.updateTransformMatrix(true);
      }
      if (!this._disableEngineStages) {
        for (const step of scene2._beforeRenderTargetDrawStage) {
          step.action(this, this._currentFaceIndex, this._currentLayer);
        }
      }
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-R2EADD4L.js").then((module) => this._dumpTools = module);
    }
...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!RegisteredTextureLoaders.has(extension)) {
    if (extension.endsWith(".ies")) {
      registerTextureLoader(".ies", async () => await import("./iesTextureLoader-MCY4BY6Y.js").then((module) => new module._IESTextureLoader()));
    }
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", async () => await import("./ddsTextureLoader-452TCEBE.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", async () => await import("./basisTextureLoader-7DLLDXMW.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", async () => await import("./envTextureLoader-Z4VMB3BG.js").then((module) => new module._ENVTextureLoader()));
    }
    if (extension.endsWith(".hdr")) {
      registerTextureLoader(".hdr", async () => await import("./hdrTextureLoader-ISID65EC.js").then((module) => new module._HDRTextureLoader()));
    }
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", async () => await import("./ktxTextureLoader-EYUDDEUJ.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", async () => await import("./ktxTextureLoader-EYUDDEUJ.js").then((module) => new module._KTXTextureLoader()));
    }
    if (extension.endsWith(".tga")) {
      registerTextureLoader(".tga", async () => await import("./tgaTextureLoader-XX42HWSQ.js").then((module) => new module._TGATextureLoader()));
    }
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", async () => await import("./exrTextureLoader-UYKWUZ7X.js").then((module) => new module._ExrTextureLoader()));
    }
  }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-VLIT5CMJ.js");
    const textures = [];
...
// node_modules/@babylonjs/core/Engines/AbstractEngine/abstractEngine.loadFile.js
...
// node_modules/@babylonjs/core/Engines/AbstractEngine/abstractEngine.textureLoaders.js
...
async function GetTextureDataAsync(texture, width, height, face = 0, lod = 0, forceRTT = false) {
...
//# sourceMappingURL=chunk-QL7QIQHJ.js.map
