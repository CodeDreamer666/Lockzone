...
var FlowGraphInterpolationBlock = class extends FlowGraphBlock {
  constructor(config = {}) {
    super(config);
    this.keyFrames = [];
    const type = typeof config?.animationType === "string" ? getRichTypeByFlowGraphType(config.animationType) : getRichTypeByAnimationType(config?.animationType ?? 0);
...
//# sourceMappingURL=chunk-6XRTZIKR.js.map
